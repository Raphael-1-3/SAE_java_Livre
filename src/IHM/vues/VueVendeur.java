...
public class VueVendeur extends BorderPane
{
     ...
     * @param LEApp
     */
    public VueVendeur(LivreExpress LEApp, ActionBD modele, Vendeur vendeure) throws SQLException
    {
        super();
        ...
        this.top();
        this.MagChoisi = this.vendeur.getMagasin();
    ...
    public void top() throws SQLException
    {
        ...
        Label nomUtil = new Label("Connecté en tant que " + this.vendeur.getNom() + " " + this.vendeur.getPrenom());
        ...
        deconnexion.setOnAction(new ControleurRetourAccueilV(this.modele, this.LEApp));
        ...
        selectionAction.setOnAction(new ControleurChangerPageV(modele, LEApp, selectionAction));
    ...
    public void panneauDeBord() throws SQLException
    {
        ...
        ControleurRechercheDynamiqueAuteurV controleurRechercheAuteur = new ControleurRechercheDynamiqueAuteurV(this.LEApp, this.modele); 
        executerrecherche.setOnAction(new ControleurSelectionGraphiqueV(this.modele, this.LEApp));
    ...
    public void ajouterLivre() 
    {
        ...
        Button bAjouter = new Button("Ajouter");
        bAjouter.setOnAction(new ControleurAjouterLivreV(this.LEApp, this.modele));
    ...
    public void regarderDisponibilites() throws SQLException 
    {
        ...
        ControleurRechercheDynamiqueV controleurRecherche = new ControleurRechercheDynamiqueV(this.LEApp, this.modele);
    ...
    public void afficherPopUpLivre(Livre l)
    {
        ...
        boutonSuppr.setOnAction(new ControleurModiferStockV(this.LEApp, this.modele, l));
    ...
    public void passerCommandeClient() throws SQLException 
    {
        ...
        ControleurPasserCommandeCliV control = new ControleurPasserCommandeCliV(this.LEApp,this.modele);
    ...
    public void transfererLivre() 
    {
        ...
        btnTransferer.setOnAction(new ControleurTransfererLivreV(modele, LEApp));
    ...
    public void choisirFactures() 
    {
        ...
        mag.setOnAction(new ControleurChoisirTypeFactureV(this.LEApp, this.modele));
        cli.setOnAction(new ControleurChoisirTypeFactureV(this.LEApp, this.modele));
    ...
    public void afficherPopUpChosirClient()
    {
        ...
        selectionner.setOnAction(new ControleurSelectionnerClientV(this.LEApp, this.modele));
    ...
    public void pannelChoisirMoisAnnee()
    {
        ...
        lancer.setOnAction(new ControleurEditerFactureV(this.LEApp, this.modele, this.clientChosi));
    ...
    public void pannelSelectionMag()
    {
        ...
        {   
            ...
            for (Magasin m : this.modele.getAllMagasins())
            {
                ...
                vb.setOnMouseClicked(new ControleurSelectionMagV(this.modele, this.LEApp, m));
    ...
    public Vendeur getclient() { return this.vendeur; }
